...
//    	sUploadURL= 'file_uploader_html5.php'; 	//upload URL
    	sUploadURL = '/SmartEditorTest/file_uploader_html5.jsp'
    	//파일을 하나씩 보내고, 결과를 받음.
...
// 	        sCallback : location.href.replace(/\/[^\/]*$/, '') + '/callback.html',	//업로드 이후에 iframe이 redirect될 콜백페이지의 주소
 			sUrl : '/SmartEditorTest/file_uploader.jsp',
 	    	sCallback : '/SmartEditorTest/SE2/photo_uploader/popup/callback.html',
