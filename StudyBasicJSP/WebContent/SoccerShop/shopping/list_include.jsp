	...
	<div class="col-lg-3 col-md-4 mb-5">
		<div class="card h-100">
			...
			<div class="card-body">
				...
				<br> <span style="text-decoration: line-through;"> 정가 :
					<%=NumberFormat.getInstance().format(productList.getProduct_price()) %>원<br>
				</span> 판매가 : <b><font color="red"><%=NumberFormat.getInstance().format((int)(productList.getProduct_price()*((double)(100-productList.getDiscount_rate())/100))) %></font></b>원
				<p class="card-text">
					제조사 :
			...
			<div class="card-footer">
				<small class="text-muted">
					<%if(productList.getProduct_count()==0){ %> <b>일시품절</b> <%}else if (productList.getProduct_count()<=10){ %>
					<font class="blink" color="red"><b>인기 상품!!</b></font> <%}else if (productList.getProduct_count()<=5){ %>
					<font class="blink" color="red"><b>>재고 얼마 없음</b></font> <%}else{ %> <font
					class="blink" color="red"><b>신제품</b></font> <%} %>
				</small>
			</div>
		</div>
	</div>
