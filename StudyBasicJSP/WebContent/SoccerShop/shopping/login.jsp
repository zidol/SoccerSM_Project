                ...
                <div class="container">
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>SoccerMall</strong></h1>
                            <div class="description">
                            	<p>
	                              	축구화 및 유니폼등 각종 축구용품을 판매 합니다.<br>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>로그인 해주세요.</h3>
                            		<p>회원로그인을 하시면 각종 혜택 및 정보를 제공 <br>받으실 수 있습니다.</p>
                        		</div>
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="contloginPro.jsp?product_id=<%=product_id %>&product_kind=<%=product_kind %>" method="post" class="login-form">
			                        ...
			                        <div class="form-group">
			                        	...
			                        	<input type="password" name="passwd" placeholder="비밀번호..." class="form-password form-control" id="form-password">
			                        </div>
			                        <input type="submit" class="btn" value="로그인">
			                        <input type="button" onclick="button_click()" class="btn" value="홈으로">
			                    </form>
		                    </div>
                        </div>
                    </div>
